...
WSGI_APPLICATION = 'sso.config.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': BASE_DIR / 'account_db.sqlite3',
    }
}
...
RSA_PRIVATE_KEY_FILE = os.path.join(RSA_KEY_DIR, env('RSA_PRIVATE_KEY_FILE_NAME', default='jwt_key.pem'))
...
SIMPLE_JWT = {
    ...
    'ALGORITHM': 'RS256',
    'SIGNING_KEY': open(RSA_PRIVATE_KEY_FILE, 'r').read(),
